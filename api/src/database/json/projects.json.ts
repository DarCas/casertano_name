...
export const projects: Projects.Project[] = [
    {
        ...
        skills: [
            "Node.js 22", "TypeScript", "Express", "TypeORM", "Joi", "Vue", "Vuetify 4", "PWA",
            "IndexedDB", "MariaDB", "MQTT", "Mosquitto", "Firebase Cloud Messaging", "Docker",
            "Dolibarr",
        ],
    ...
    },
    {
        ...
        skills: [
            "TypeScript", "Node.js", "Express.js", "TypeORM", "MariaDB", "DeepAgents", "LangChain",
            "OpenAI", "OpenAI Vision", "Gmail API", "IMAP", "OAuth2", "Vue 3", "Vuetify", "Docker",
        ],
    ...
    },
    {
        ...
        skills: [
            "Solidity", "Ethers.js", "Polygon", "ERC-721", "PHP", "Zend Framework 3", "Node.js",
            "Express", "TypeORM", "MariaDB", "Vue", "Vuetify", "PWA", "Firebase", "MetaMask",
            "IPFS", "PM2", "Filebase",
        ],
        slug: "bitmonds",
    ...
    },
    {
        ...
        skills: [
            "TypeScript", "Node.js 22", "yargs", "grammY", "Telegram API", "OpenAI API", "Firebase",
            "WebSocket", "EMSC/CSEM", "DPC", "INGV", "USGS", "SQLite", "TypeORM", "Migrazioni",
            "GeoJSON", "KML", "ogr2ogr", "TopoJSON", "Docker", "Docker Compose", "rsync", "Sentry",
        ],
    ...
    },
    {
        ...
        skills: [
            "Node.js 22", "TypeScript strict", "Fastify 5", "TypeBox", "Valhalla", "Vue 3",
            "Vuetify 4", "Leaflet", "PWA", "Docker", "SQLite", "Drizzle ORM", "Dexie",
    ...
    },
    {
        ...
        skills: [
            "Vue", "TypeScript", "Vuetify 3", "Composition API", "Vite", "Pinia", "WebRTC",
            "TURN/STUN", "coturn", "Node.js", "Firebase Realtime DB", "Docker", "Docker Compose",
            "Workbox", "Dexie.js", "Sentry",
        ],
    ...
    },
    {
        ...
        skills: [
            "PHP", "Laravel 12", "REST API", "Eloquent", "MariaDB", "PhpWord", "Vue 3", "Vuetify 3",
            "TypeScript", "Vee-Validate", "Zod", "PWA", "Adobe PDF Services API", "Tools4Isp API",
            "Docker",
        ],
        slug: "piattaforma-onboarding-clienti-isp",
        tags: ["Laravel 12", "Vue 3", "TypeScript", "PWA", "Docker"],
    ...
    },
    {
        ...
        skills: [
            "Node.js", "Express", "TypeORM", "MariaDB", "JWT", "Joi", "Vue", "Vuetify", "PWA",
            "TypeScript", "Vuex", "Service Worker", "grammy", "Docker", "Docker Compose", "Apache",
    ...
    },
    {
        ...
        skills: [
            "PHP", "MySQL", "Moodle", "Composer", "PHPUnit", "JavaScript", "CSS", "Sass",
            "Webpack Encore", "jQuery", "PostCSS", "Node.js",
        ],
        slug: "piattaforma-e-learning-moodle",
        tags: ["Moodle", "PHP", "MySQL", "Webpack", "JavaScript"],
    ...
    },
    {
        ...
        skills: [
            "Angular 7", "TypeScript", "RxJS", "Service Worker", "Dexie/IndexedDB", "PHP 7.2",
            "Zend Framework 3", "Doctrine ORM", "MySQL", "Microsoft SQL Server", "REST API", "JWT",
            "Vue 2", "Vuetify", "mPDF",
        ],
        slug: "ordini-su-misura-agenti-vendita",
        tags: ["Angular", "PHP", "Vue 2", "PWA", "Microsoft SQL Server"],
    ...
    },
    {
        ...
        skills: [
            "TypeScript", "ES2015", "Strict Typing", "Abstract Class", "Strategy Pattern", "Lodash",
            "localStorage", "sessionStorage", "JSON", "Terser", "Source Map", "ES6 Modules", "npm",
            "Semantic Versioning", "Open Source",
        ],
        slug: "keyplex",
        tags: ["TypeScript", "npm", "Strategy Pattern", "Terser"],
    ...
    },
    {
        ...
        skills: [
            "TypeScript", "Vite", "Rollup", "JavaScript", "rollup-plugin-license", "terser",
            "GitHub Actions", "npm", "Node.js", "JSON", "Compliance licenze",
        ],
        slug: "rollup-plugin-license-json",
        tags: ["Vite", "TypeScript", "Rollup", "GitHub Actions", "Open Source"],
    ...
    },
    {
        ...
        skills: [
            "TypeScript", "JavaScript", "Node.js", "Browser API", "Lodash", "Key-Value Store",
            "npm", "Terser", "Build Automation",
        ],
        slug: "memoryx",
        tags: ["TypeScript", "npm", "Key-Value Store", "Lodash"],
    ...
    },
    {
        ...
        skills: [
            "TypeScript", "Rollup", "Vite", "Subresource Integrity", "SHA-256", "SHA-384", "SHA-512",
            "npm", "MIT License", "GitHub Actions", "Build Tooling", "Security",
        ],
        slug: "rollup-subresource-integrity",
        tags: ["Rollup", "Vite", "SRI", "TypeScript", "Open Source"],
