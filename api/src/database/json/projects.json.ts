...
export const projects: Projects.Project[] = [
    ...
    },
    {
        ...
        skills: [
            "PHP", "Laravel 12", "REST API", "Eloquent", "MariaDB", "PhpWord",
            "Vue 3", "Vuetify 3", "TypeScript", "Vee-Validate", "Zod", "PWA",
            "Adobe PDF Services API", "Tools4Isp API", "Docker",
        ],
        media: [],
    },
    {
    ...
    },
    {
        ...
        skills: [
            "PHP", "MySQL", "Moodle", "Composer", "PHPUnit",
            "JavaScript", "CSS", "Sass", "Webpack Encore", "jQuery", "PostCSS", "Node.js",
        ],
        media: [],
    },
    {
        ...
        skills: [
            "Angular 7", "TypeScript", "RxJS", "Service Worker", "Dexie/IndexedDB",
            "PHP 7.2", "Zend Framework 3", "Doctrine ORM", "MySQL", "Microsoft SQL Server",
            "REST API", "JWT", "Vue 2", "Vuetify", "mPDF",
        ],
        media: [],
    },
    {
        ...
        skills: [
            "TypeScript", "ES2015", "Strict Typing", "Abstract Class", "Strategy Pattern",
            "Lodash", "localStorage", "sessionStorage", "JSON", "Terser",
            "Source Map", "ES6 Modules", "npm", "Semantic Versioning", "Open Source",
        ],
        slug: "keyplex",
    ...
    },
    {
        ...
        skills: [
            "TypeScript", "Vite", "Rollup", "JavaScript", "rollup-plugin-license",
            "terser", "GitHub Actions", "npm", "Node.js", "JSON", "Compliance licenze",
        ],
    ...
    },
    {
        ...
        skills: [
            "TypeScript", "JavaScript", "Node.js", "Browser API", "Lodash",
            "Key-Value Store", "npm", "Terser", "Build Automation",
        ],
        slug: "memoryx",
