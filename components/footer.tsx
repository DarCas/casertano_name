...
const socials = [
  {
    href: "https://linkedin.com/in/dariocasertano",
    label: "LinkedIn",
    ...
    <footer className="border-t border-white/[0.04] py-12 px-8">
      <div className="max-w-[1100px] mx-auto flex flex-col md:flex-row justify-between gap-8">
        <div className="flex flex-col items-start gap-1.5">
          <p className="font-mono text-[0.8rem] text-text">Dario Casertano</p>
          <p className="font-mono text-[0.65rem] text-text-secondary tracking-[0.05em]">&copy; {yearRange} — Tutti i diritti riservati.</p>
          <p className="font-mono text-[0.6rem] text-text-secondary tracking-[0.05em]">P.IVA 07382860729 &middot; REA BA-553179</p>
