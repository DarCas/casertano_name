    ...
    <footer className="border-t border-white/[0.04] py-12 px-8">
      <div className="max-w-[1100px] mx-auto flex flex-col md:flex-row justify-between items-start gap-8">
        ...
        <div className="flex items-center gap-3">
          <EmailLink aria-label="E-Mail" className="inline-flex items-center justify-center w-9 h-9 rounded-lg border border-white/[0.06] text-text-secondary transition-colors duration-200 no-underline hover:text-accent-secondary hover:border-accent-secondary">
